...
const benefits = [
  { title: 'Sorgfältige Montage', text: 'Saubere Ausführung mit Blick auf jedes Detail.', icon: CircleCheckBig },
  { title: 'Pünktliche Termine', text: 'Wir kommen zuverlässig und halten unsere Zeitpläne ein.', icon: Clock3 },
  { title: 'Erfahrenes Team', text: 'Viele Jahre Erfahrung für perfekte Ergebnisse.', icon: Workflow },
  { title: 'Faire Preise', text: 'Transparente Preise ohne versteckte Kosten.', icon: PackageCheck },
];

const furnitureItems = [
  { title: 'IKEA', icon: Cuboid },
  { title: 'Kleiderschränke', icon: BedDouble },
  { title: 'Betten', icon: BedDouble },
  { title: 'Regale', icon: BedDouble },
  { title: 'Kommoden', icon: BedDouble },
  { title: 'Büromöbel', icon: LampDesk },
];

const steps = ['Anfrage', 'Angebot', 'Termin', 'Montage', 'Fertig'];

const faqs = [
  {
    question: 'Welche Möbel montieren Sie?',
    answer: 'Wir montieren IKEA-Möbel, Kleiderschränke, Betten, Regale, Kommoden und Büromöbel.',
  },
  {
    question: 'Wie schnell können Sie kommen?',
    answer: 'Je nach Verfügbarkeit können wir oft kurzfristig Termine anbieten.',
  },
  {
    question: 'Gibt es einen Mindestauftragswert?',
    answer: 'Nein, wir übernehmen auch kleinere Einzelaufträge zuverlässig und professionell.',
  },
  {
    question: 'Müssen Sie vorher etwas vorbereiten?',
    answer: 'Bitte stellen Sie sicher, dass die benötigten Teile und Werkzeuge verfügbar sind.',
  },
  {
    question: 'Montieren Sie auch in Mietwohnungen?',
    answer: 'Ja, wir montieren gerne auch in Mietwohnungen und Büros.',
  },
];

export default function MöbelmontagePageClient() {
  ...
  return (
    <main className="bg-[#fafafa] text-[#111111]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.02fr_0.98fr]">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: 'easeOut' }} className="max-w-2xl">
            ...
            <p className="mt-8 max-w-xl text-lg leading-8 text-black/65 sm:text-xl">
              Wir montieren Möbel aller bekannten Hersteller – sorgfältig, sauber und termingerecht.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 24 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: 'easeOut', delay: 0.08 }} className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2.25rem] border border-black/5 bg-white p-2 shadow-[0_30px_90px_rgba(0,0,0,0.12)]">
              <Image src="/images/montage.jpg" alt="Professionelle Möbelmontage von MENVOTI" width={1200} height={1400} priority sizes="(max-width: 768px) 100vw, (max-width: 1280px) 50vw, 42vw" className="h-[28rem] w-full rounded-[1.75rem] object-cover sm:h-[34rem] lg:h-[40rem]" />
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.02em] text-black sm:text-4xl">Montage, die sich anfühlt wie ein Premium-Service.</h2>
          </div>
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold uppercase tracking-[0.35em] text-black/50">Welche Möbel?</p>
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.02em] text-black sm:text-4xl">Wir montieren alles, was Ihr Zuhause braucht.</h2>
          </div>
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-[-0.02em] text-black sm:text-4xl">So läuft Ihre Montage stressfrei ab.</h2>
          </div>
